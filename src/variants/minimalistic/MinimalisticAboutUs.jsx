...
export default function MinimalisticAboutUs() {
  return (
    <section id="o-nas" className="py-16 md:py-20 bg-stone-100/60 border-y border-stone-200 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          
          {/* Karol Mastalerz */}
          <div className="border border-stone-200 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between h-full text-left bg-white text-stone-900 font-sans">
          ...
          <div className="border border-stone-200 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between h-full text-left bg-white text-stone-900 font-sans">
            <div className="p-6 flex flex-col sm:flex-row gap-5 items-start sm:items-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-stone-500 font-light font-sans">Uniwersytet Warszawski</p>
              </div>
            </div>
